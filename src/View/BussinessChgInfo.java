...
public class BussinessChgInfo extends JInternalFrame {
	...
	private Bussiness bussiness= (Bussiness)bussiness_main.bussinessobject;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					BussinessChgInfo frame = new BussinessChgInfo();
	 ...
	 * Create the frame.
	 */
	public BussinessChgInfo() {
		
		//÷¥––read–≈œ¢≤Ÿ◊˜
		BussinessObj bussinessobj= new BussinessObj();
		//System.out.println(admin.getAccount());           µ˜ ‘”Ôæ‰
		readinfo= bussinessobj.readinfo(bussiness.getAccount());              //readinfo”√¿¥¥Ú”°
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				BussinessObj bussinessobj= new BussinessObj();
				JOptionPane.showMessageDialog(null,bussinessobj.writeinfo(bussiness.getAccount(),textField.getText(),textField_1.getText(),textField_2.getText(),textField_3.getText(),textField_4.getText()));
			}
		});
