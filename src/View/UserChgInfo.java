...
public class UserChgInfo extends JInternalFrame {
	...
	private User user= (User)user_main.userobject;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					UserChgInfo frame = new UserChgInfo();
	...
	public UserChgInfo() {
		...
		readinfo= userobj.readinfo(user.getAccount());              //readinfo”√¿¥¥Ú”°
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				UserObj userobj= new UserObj();
				JOptionPane.showMessageDialog(null,userobj.writeinfo(user.getAccount(),textField.getText(),textField_1.getText(),textField_2.getText(),textField_3.getText(),textField_4.getText()));
			}
		});
